...
contract NftWallet is Ownable{
    mapping(uint256 => address) public collector; // sender=>covrage
    uint256 covrage; // saved item id (a db), seprate owners
    uint256 private holdTime = 1 weeks;
